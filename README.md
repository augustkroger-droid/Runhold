...
6. Kör SQL-migrationerna i `supabase/migrations/001_initial_schema.sql` till och med `supabase/migrations/015_expedition_results.sql` via Supabase SQL Editor, eller med Supabase CLI om du använder CLI lokalt. Migration 011 skapar reparationer, HP-skada och repair timers. Migration 012 skapar tech tree och låser muren bakom `basic_wall`. Migration 013 skapar expeditionssammanfattningar och XP-belöningar. Migration 014 skapar spelarspecifika kartsektorer, scanner-resultat och automatisk uppsamling. Migration 015 gör expeditionens haul serverstyrd och flyttar resurser till förrådet när expeditionen avslutas.
